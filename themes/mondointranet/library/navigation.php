...
/**
 * Manager Navigation - additional menu item in side menu
 */

if ( ! function_exists( 'manager_nav' ) ) {
    function manager_nav() {
        wp_nav_menu(array(
        'container' => false,                           // Remove nav container
        'menu_class' => 'menu',                     // Adding custom nav class
        'items_wrap'     => '<ul id="%1$s" class="%2$s">%3$s</ul>',
        'theme_location' => 'manager-nav',                // Where it's located in the theme
        'depth' => 3,                                   // Limit the depth of the nav
        'fallback_cb' => false,                         // Fallback function (see below)
        ));
    }
...
/**
 * Directory navigation - by Location
 */
if ( ! function_exists( 'foundationpress_directory_nav' ) ) {
    function foundationpress_directory_nav() {
        wp_nav_menu(array(
        'container' => false,                           // Remove nav container
        'menu_class' => 'menu',                    // Adding custom nav class
        'items_wrap'     => '<ul id="%1$s" class="%2$s">%3$s</ul>',
        'theme_location' => 'directory-nav',                // Where it's located in the theme
        'depth' => 3,                                   // Limit the depth of the nav
        'fallback_cb' => false,                         // Fallback function (see below)
