...
function loadWeather(location, woeid) {
  $.simpleWeather({
    ...
    success: function(weather) {
      html = '<div id="conditionsWrapper"><div class="weather-conditions"><div class="columns no-pad small-6"><div class="current-temp">'+weather.temp+'&deg;<span class="deg-f">'+weather.units.temp+'</span></div><div class="current-weather">'+weather.currently+'</div></div><div class="columns small-6 no-pad"><div class="weather-icon"><i class="icon-'+weather.code+'"></i></div></div></div>';
      html += '<div class="weather-city"><span class="fa fa-map-marker"></span>'+weather.city+', '+weather.region+'</div></div>';
