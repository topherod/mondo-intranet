...
<section id="respond" class="comments-respond">
	<h4><?php comment_form_title( __( 'Add Comment', 'foundationpress' ), __( 'Leave a Reply to %s', 'foundationpress' ) ); ?></h4>
...
<!-- 		<p id="allowed_tags" class="small"><strong>XHTML:</strong> 
		...
		<p class="submit-area"><input name="submit" class="button" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e( 'Add Comment', 'foundationpress' ); ?>"></p>
	...
	<?php 
		if ( get_post_type() === 'interest-group' ) {
