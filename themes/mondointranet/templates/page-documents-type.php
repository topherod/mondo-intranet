<?php
/*
Template Name: Documents by Type
*/
get_header(); ?>
...
<div id="page-full-width" class="full-documents" role="main">
  ...
  <?php $document_type = get_the_title(); ?>
  <div class="documents header">
    ...
    <h1 class="entry-title">Documents - <?php the_title(); ?></h1>
    <?php the_content(); ?>
    <?php endwhile;?>
    <?php wp_reset_query(); ?>
    <div class="document row doc-row-labels">
      ...
      <form type="post" action="" id="sort_form" style="display: none;">
        ...
        <input name="document_type" id="document_type" value="<?php echo $document_type; ?>"/>
