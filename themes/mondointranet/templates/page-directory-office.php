<?php
/*
Template Name: Directory by Office
*/
get_header(); ?>
...
<div id="page-full-width" class="full-employee-directory" role="main">
    ...
    <div class="directory header">
      ...
      <h1 class="entry-title">Employee Directory - <?php the_title(); ?></h1>
      <?php the_content(); ?>
...
echo sanitize_title_with_dashes( get_field('office') ); ?>">
      ...
      <div class="employee-sub-info">
        <?php if ( !empty( get_field('email_address') ) ) { ?>
        ...
        <?php } ?>
        <p><span class="fa fa-map-marker"></span> <?php the_field('office') ?></p>
      </div>
